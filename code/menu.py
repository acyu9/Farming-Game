...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        # Distinguish between selling and buying in the options later
    ...
    def display_money(self):
        ...
        pygame.draw.rect(self.display_surface, 'Beige', text_rect.inflate(10,10), 0, 4)
    ...
    def show_entry(self, text_surf, amount, top, selected):
        ...
        pygame.draw.rect(self.display_surface, 'Beige', bg_rect, 0, 4)
